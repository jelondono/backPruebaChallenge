...
public class PrescriptionServiceImpl implements PrescriptionService {
    ...
    private void validatePrescriptionLimits(Patient patient,List<Medicine> medicines, LocalDateTime prescriptionDate) {
        ...
        int totalMedicines = prescriptions.stream().mapToInt(p -> p.getMedicines().size()).sum() + medicines.size();
        ...
        if (prescriptions.stream().anyMatch(p -> p.getMedicines().containsAll(medicines))) {
