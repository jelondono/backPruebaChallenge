...
import com.api.utilities.exceptions.ResourceNotFoundException;
...
public class PatientServiceImpl implements PatientService {
    ...
    public Patient updatePatient(Long id, Patient patient) {
        Patient existingPatient = patientRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Paciente", "id", id));
